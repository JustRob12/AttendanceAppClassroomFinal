...
CREATE TABLE `attendance` (
  ...
  CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`classId`) REFERENCES `classes` (`id`) ON DELETE CASCADE,
...
INSERT INTO `attendance` VALUES (78,7,15,'present','2025-04-12','19:12:16'),(79,7,16,'present','2025-04-12','22:42:11');
